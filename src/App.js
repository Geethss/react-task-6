...
import './App.css';
import geetImage from "./geet.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={geetImage} alt="P.S.Geethanjali" />
          <h3 className="name">P.S.Geethanjali</h3>
        </div>
      ...
      <section className="home" id="home">
        ...
        <h1>This is <span>Pedamallu Sri Geethanjali</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span> Geethanjali </h3>
            ...
            <h3> <span> Hobbies: </span> Reading Books, Travelling, Listening to music, Watching movies </h3>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> psrigeethanjali@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9493158129</h3>
